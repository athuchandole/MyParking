            ...
            <ScrollView>
                ...
                <View style={styles.sectionPadding}>
                    ...
                    <View style={styles.vehicleCard}>
                        ...
                        <View style={styles.vehicleDetails}>
                            ...
                            <View style={[styles.activeBadge, { backgroundColor: item.status === "active" ? "#e0f2fe" : "#fee2e2" }]}>
                                <Text style={[styles.activeText, { color: item.status === "active" ? "#137fec" : "#dc2626" }]}>
                ...
                <View style={styles.sectionPadding}>
                    ...
                    <View style={styles.receiptCard}>
                        ...
                        <ReceiptRow icon="clock-outline" label="Total Duration" value={`${hours}h ${minutes}m`} highlight />

                        <View style={styles.amountBox}>

                            <View>
                                <Text style={styles.amountLabel}>Total Amount Due</Text>
                                <Text style={styles.amountValue}>₹{amount}.00</Text>
                            </View>
...
const styles = StyleSheet.create({
    ...
    vehicleCard: { backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: '#e2e8f0', overflow: 'hidden' },
    vehicleImage: { width: '100%', height: 180 },
    vehicleOverlay: { position: 'absolute', bottom: 10, left: 10, backgroundColor: 'rgba(255,255,255,0.9)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6 },
    overlayText: { fontSize: 11, fontWeight: '700', color: '#137fec' },
    vehicleDetails: { flexDirection: 'row', justifyContent: 'space-between', padding: 14 },
    vehicleNumber: { fontSize: 20, fontWeight: '800' },
    ...
    terminalText: { textAlign: 'center', marginTop: 8, fontSize: 11, color: '#94a3b8' }
});