...
const styles = StyleSheet.create({
    ...
    captureBox: { flex: 1, marginHorizontal: 5, aspectRatio: 1, backgroundColor: '#f3f4f6', height: 120, borderRadius: 16, borderWidth: 2, borderStyle: 'dashed', borderColor: '#d1d5db', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
